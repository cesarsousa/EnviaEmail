...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	<xsl:output method="xml" version="1.0" encoding="UTF-8" indent="yes" doctype-system="brf114-request-v2.6.dtd"/>
	...
	<xsl:template match="PG_PEDIDO">
		...
		<xsl:element name="info-processo">
			...
			<xsl:element name="info-peticao">			
				...
				<info tipo="REQUER_1" descricao="Requerimento de Opinião Preliminar sobre a Patenteabilidade"><xsl:value-of select="string(boolean(TPN_PEDIDO/TPN_REQUER/CB_REQUER_32 = $true))"/></info>
				<info tipo="REQUER_2" descricao="Manifestação à Opinião Preliminar sobre a Patenteabilidade"><xsl:value-of select="string(boolean(TPN_PEDIDO/TPN_REQUER/CB_REQUER_33 = $true))"/></info>
				<info tipo="REQUER_3" descricao="Modificação no Relatório Descritivo"><xsl:value-of select="string(boolean(TPN_PEDIDO/TPN_REQUER/CB_REQUER_1 = $true))"/></info>
				<info tipo="REQUER_4" descricao="Modificações nas Reivindicações"><xsl:value-of select="string(boolean(TPN_PEDIDO/TPN_REQUER/CB_REQUER_2 = $true))"/></info>
				<info tipo="REQUER_5" descricao="Modificações nos Desenhos"><xsl:value-of select="string(boolean(TPN_PEDIDO/TPN_REQUER/CB_REQUER_3 = $true))"/></info>
				<info tipo="REQUER_6" descricao="Modificações no Resumo"><xsl:value-of select="string(boolean(TPN_PEDIDO/TPN_REQUER/CB_REQUER_4 = $true))"/></info>
				<info tipo="REQUER_7" descricao="Documento de Prioridade"><xsl:value-of select="string(boolean(TPN_PEDIDO/TPN_REQUER/CB_REQUER_8 = $true))"/></info>
				<info tipo="REQUER_8" descricao="Procuração"><xsl:value-of select="string(boolean(TPN_PEDIDO/TPN_REQUER/CB_REQUER_13 = $true))"/></info>
				<info tipo="REQUER_9" descricao="Publicação Antecipada"><xsl:value-of select="string(boolean(TPN_PEDIDO/TPN_REQUER/CB_REQUER_15 = $true))"/></info>
				<info tipo="REQUER_OUTROS_10" descricao="Outros documentos"><xsl:value-of select="string(boolean(TPN_PEDIDO/TPN_REQUER/CB_REQUER_OUTROS = $true))"/></info>
