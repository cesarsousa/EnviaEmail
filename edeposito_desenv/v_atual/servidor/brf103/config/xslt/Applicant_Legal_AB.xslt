			...
			<xsl:for-each select="/CLCN_ITEM_DEP_PJ">
				<person person-type="legal">
					...
					<address>
						...
						<district>	
							<xsl:if test="not(PNL_DEP_PJ_ENDERECO/CCBB_DEP_PJ_PAIS='BR') and not(PNL_DEP_PJ_ENDERECO/CCBB_DEP_PJ_PAIS='ES') and not(PNL_DEP_PJ_ENDERECO/CCBB_DEP_PJ_PAIS='GB') and not(PNL_DEP_PJ_ENDERECO/CCBB_DEP_PJ_PAIS='AU') and not(PNL_DEP_PJ_ENDERECO/CCBB_DEP_PJ_PAIS='US') and not(PNL_DEP_PJ_ENDERECO/CCBB_DEP_PJ_PAIS='CA') and not(PNL_DEP_PJ_ENDERECO/CCBB_DEP_PJ_PAIS='JP') and not(PNL_DEP_PJ_ENDERECO/CCBB_DEP_PJ_PAIS='CN')">
								<xsl:value-of select="PNL_DEP_PJ_ENDERECO/ED_DEP_PJ_ESTADO"/>
							</xsl:if>
							<xsl:if test="(PNL_DEP_PJ_ENDERECO/CCBB_DEP_PJ_PAIS='BR') or (PNL_DEP_PJ_ENDERECO/CCBB_DEP_PJ_PAIS='ES') or (PNL_DEP_PJ_ENDERECO/CCBB_DEP_PJ_PAIS='GB') or (PNL_DEP_PJ_ENDERECO/CCBB_DEP_PJ_PAIS='AU') or (PNL_DEP_PJ_ENDERECO/CCBB_DEP_PJ_PAIS='US') or (PNL_DEP_PJ_ENDERECO/CCBB_DEP_PJ_PAIS='CA') or (PNL_DEP_PJ_ENDERECO/CCBB_DEP_PJ_PAIS='JP') or (PNL_DEP_PJ_ENDERECO/CCBB_DEP_PJ_PAIS='CN') ">
								<xsl:value-of select="''"/>
							</xsl:if>
						</district>
					</address>
