...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	...
	<xsl:template match="info-processo">
		<xsl:element name="TPN_PEDIDO">
			...
			<xsl:element name="TPN_AREA_TECNOLOGICA">			
				<xsl:element name="RB_AREA_TEC_ENERGIA">
					<xsl:value-of select="string(boolean(info-peticao/info[@tipo='AREATEC_1'] = $true))"/>
				</xsl:element>
				<xsl:element name="RB_AREA_TEC_TRANSPORTE">
					<xsl:value-of select="string(boolean(info-peticao/info[@tipo='AREATEC_2'] = $true))"/>
				</xsl:element>				
				<xsl:element name="RB_AREA_TEC_CONSERVACAO">
					<xsl:value-of select="string(boolean(info-peticao/info[@tipo='AREATEC_3'] = $true))"/>
				</xsl:element>
				<xsl:element name="RB_AREA_TEC_GERENCIAMENTO">
					<xsl:value-of select="string(boolean(info-peticao/info[@tipo='AREATEC_4'] = $true))"/>	
				</xsl:element>
				<xsl:element name="RB_AREA_TEC_AGRICULTURA">
					<xsl:value-of select="string(boolean(info-peticao/info[@tipo='AREATEC_5'] = $true))"/>
				</xsl:element>
			</xsl:element>
			...
			<xsl:element name="TPN_REQUER">			
				...
				<xsl:element name="CB_REQUER_OUTROS">
					<xsl:value-of select="string(boolean(info-peticao/info[@tipo='REQUER_OUTROS_9'] = $true))"/>					
				</xsl:element>
