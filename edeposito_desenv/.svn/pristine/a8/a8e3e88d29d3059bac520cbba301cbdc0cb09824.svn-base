...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	<xsl:output method="xml" version="1.0" encoding="UTF-8" indent="yes" doctype-system="brf102-request-v2.6.dtd"/>
	...
	<xsl:variable name="existeGruPaga">
		<xsl:value-of select="count(//PG_DOCUMENTO/PC_DOCUMENTO/TS_OUTROSDOCUMENTOS/CLCN_ITEM_OUTROSDOCUMENTOS/PNL_GRU_entity)"/>		
	</xsl:variable>

	<!-- ******************************************************* -->
	
	<!-- Inicando processamento -->
	<xsl:template match="BRF102">
	...
	<xsl:template match="PG_PEDIDO">
		...
		<xsl:element name="info-processo">
			...
			<xsl:element name="info-peticao">			
				...
				<info tipo="REQUER_1" descricao="Modificação no Relatório Descritivo"><xsl:value-of select="string(boolean(TPN_PEDIDO/TPN_REQUER/CB_REQUER_1 = $true))"/></info>
				<info tipo="REQUER_2" descricao="Modificações nas Reivindicações"><xsl:value-of select="string(boolean(TPN_PEDIDO/TPN_REQUER/CB_REQUER_2 = $true))"/></info>
				<info tipo="REQUER_3" descricao="Modificações nos Desenhos"><xsl:value-of select="string(boolean(TPN_PEDIDO/TPN_REQUER/CB_REQUER_3 = $true))"/></info>
				<info tipo="REQUER_4" descricao="Modificações no Resumo"><xsl:value-of select="string(boolean(TPN_PEDIDO/TPN_REQUER/CB_REQUER_4 = $true))"/></info>
				<info tipo="REQUER_5" descricao="Esclarecimentos / razões"><xsl:value-of select="string(boolean(TPN_PEDIDO/TPN_REQUER/CB_REQUER_5 = $true))"/></info>
				<info tipo="REQUER_6" descricao="Cumprimento ou Contestação de Exigência"><xsl:value-of select="string(boolean(TPN_PEDIDO/TPN_REQUER/CB_REQUER_6 = $true))"/></info>
				<info tipo="REQUER_7" descricao="Desarquivamento"><xsl:value-of select="string(boolean(TPN_PEDIDO/TPN_REQUER/CB_REQUER_7 = $true))"/></info>
				<info tipo="REQUER_8" descricao="Documento de Prioridade"><xsl:value-of select="string(boolean(TPN_PEDIDO/TPN_REQUER/CB_REQUER_8 = $true))"/></info>
				<info tipo="REQUER_9" descricao="Documento de Cessão"><xsl:value-of select="string(boolean(TPN_PEDIDO/TPN_REQUER/CB_REQUER_9 = $true))"/></info>
				<info tipo="REQUER_10" descricao="Exame do Pedido"><xsl:value-of select="string(boolean(TPN_PEDIDO/TPN_REQUER/CB_REQUER_10 = $true))"/></info>
				<info tipo="REQUER_11" descricao="Expedição da carta Patente / Certificado de Adição"><xsl:value-of select="string(boolean(TPN_PEDIDO/TPN_REQUER/CB_REQUER_11 = $true))"/></info>
				<info tipo="REQUER_12" descricao="Manifestação sobre Ciência"><xsl:value-of select="string(boolean(TPN_PEDIDO/TPN_REQUER/CB_REQUER_12 = $true))"/></info>
				<info tipo="REQUER_13" descricao="Procuração"><xsl:value-of select="string(boolean(TPN_PEDIDO/TPN_REQUER/CB_REQUER_13 = $true))"/></info>
				<info tipo="REQUER_14" descricao="Destituição de procurador e/ou novo procurador"><xsl:value-of select="string(boolean(TPN_PEDIDO/TPN_REQUER/CB_REQUER_14 = $true))"/></info>
				<info tipo="REQUER_15" descricao="Publicação Antecipada"><xsl:value-of select="string(boolean(TPN_PEDIDO/TPN_REQUER/CB_REQUER_15 = $true))"/></info>
				<info tipo="REQUER_16" descricao="Listagem de sequências"><xsl:value-of select="string(boolean(TPN_PEDIDO/TPN_REQUER/CB_REQUER_16 = $true))"/></info>
				<info tipo="REQUER_17" descricao="Cópia Oficial do Pedido Depositado"><xsl:value-of select="string(boolean(TPN_PEDIDO/TPN_REQUER/CB_REQUER_17 = $true))"/></info>
				<info tipo="REQUER_18" descricao="Caducidade da Patente / Certificado de Adição"><xsl:value-of select="string(boolean(TPN_PEDIDO/TPN_REQUER/CB_REQUER_18 = $true))"/></info>
				<info tipo="REQUER_19" descricao="Contestação de Caducidade / Nulidade"><xsl:value-of select="string(boolean(TPN_PEDIDO/TPN_REQUER/CB_REQUER_19 = $true))"/></info>
				<info tipo="REQUER_20" descricao="Nulidade da Patente / Certificado de Adição"><xsl:value-of select="string(boolean(TPN_PEDIDO/TPN_REQUER/CB_REQUER_20 = $true))"/></info>
				<info tipo="REQUER_21" descricao="Recurso contra o Indeferimento"><xsl:value-of select="string(boolean(TPN_PEDIDO/TPN_REQUER/CB_REQUER_21 = $true))"/></info>
				<info tipo="REQUER_22" descricao="Recurso contra o Arquivamento"><xsl:value-of select="string(boolean(TPN_PEDIDO/TPN_REQUER/CB_REQUER_22 = $true))"/></info>
				<info tipo="REQUER_23" descricao="Recurso (outros)"><xsl:value-of select="string(boolean(TPN_PEDIDO/TPN_REQUER/CB_REQUER_23 = $true))"/></info>
				<info tipo="REQUER_24" descricao="Renúncia da Patente"><xsl:value-of select="string(boolean(TPN_PEDIDO/TPN_REQUER/CB_REQUER_24 = $true))"/></info>
				<info tipo="REQUER_25" descricao="Restauração de Pedido / Patente"><xsl:value-of select="string(boolean(TPN_PEDIDO/TPN_REQUER/CB_REQUER_25 = $true))"/></info>
				<info tipo="REQUER_26" descricao="Retirada do Pedido"><xsl:value-of select="string(boolean(TPN_PEDIDO/TPN_REQUER/CB_REQUER_26 = $true))"/></info>
				<info tipo="REQUER_27" descricao="Subsídio ao Exame Técnico"><xsl:value-of select="string(boolean(TPN_PEDIDO/TPN_REQUER/CB_REQUER_27 = $true))"/></info>
				<info tipo="REQUER_28" descricao="Aditamento"><xsl:value-of select="string(boolean(TPN_PEDIDO/TPN_REQUER/CB_REQUER_28 = $true))"/></info>
				<info tipo="REQUER_29" descricao="Tradução"><xsl:value-of select="string(boolean(TPN_PEDIDO/TPN_REQUER/CB_REQUER_29 = $true))"/></info>
				<info tipo="REQUER_30" descricao="Oferta de Licença"><xsl:value-of select="string(boolean(TPN_PEDIDO/TPN_REQUER/CB_REQUER_30 = $true))"/></info>
