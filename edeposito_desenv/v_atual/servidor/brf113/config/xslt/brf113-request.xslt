...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	<xsl:output method="xml" version="1.0" encoding="UTF-8" indent="yes" doctype-system="brf113-request-v2.5.dtd"/>
	...
	<xsl:template match="PG_PEDIDO">
		...
		<xsl:element name="info-processo">
			...
			<xsl:element name="info-peticao">	
				...
				<info tipo="AREATEC_1" descricao="Energia Alternativa"><xsl:value-of select="string(boolean(TPN_PEDIDO/TPN_AREA_TECNOLOGICA/RB_AREA_TEC_ENERGIA = $true))"/></info>
				<info tipo="AREATEC_2" descricao="Transporte"><xsl:value-of select="string(boolean(TPN_PEDIDO/TPN_AREA_TECNOLOGICA/RB_AREA_TEC_TRANSPORTE = $true))"/></info>
				<info tipo="AREATEC_3" descricao="Conservação de Energia"><xsl:value-of select="string(boolean(TPN_PEDIDO/TPN_AREA_TECNOLOGICA/RB_AREA_TEC_CONSERVACAO = $true))"/></info>
				<info tipo="AREATEC_4" descricao="Gerenciamento de Resíduos"><xsl:value-of select="string(boolean(TPN_PEDIDO/TPN_AREA_TECNOLOGICA/RB_AREA_TEC_GERENCIAMENTO = $true))"/></info>
				<info tipo="AREATEC_5" descricao="Agricultura"><xsl:value-of select="string(boolean(TPN_PEDIDO/TPN_AREA_TECNOLOGICA/RB_AREA_TEC_AGRICULTURA = $true))"/></info>
				...
				<info tipo="REQUER_5" descricao="Documento de Prioridade"><xsl:value-of select="string(boolean(TPN_PEDIDO/TPN_REQUER/CB_REQUER_8 = $true))"/></info>
				<info tipo="REQUER_6" descricao="Exame do Pedido"><xsl:value-of select="string(boolean(TPN_PEDIDO/TPN_REQUER/CB_REQUER_10 = $true))"/></info>
				<info tipo="REQUER_7" descricao="Procuração"><xsl:value-of select="string(boolean(TPN_PEDIDO/TPN_REQUER/CB_REQUER_13 = $true))"/></info>
				<info tipo="REQUER_8" descricao="Publicação Antecipada"><xsl:value-of select="string(boolean(TPN_PEDIDO/TPN_REQUER/CB_REQUER_15 = $true))"/></info>
				<info tipo="REQUER_OUTROS_9" descricao="Outros documentos"><xsl:value-of select="string(boolean(TPN_PEDIDO/TPN_REQUER/CB_REQUER_OUTROS = $true))"/></info>
