...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	<xsl:output method="xml" version="1.0" encoding="UTF-8" indent="yes" doctype-system="brf105-request-v2.5.dtd"/>
			...
			<xsl:element name="info-peticao">
				...
				<xsl:element name="info">
					<xsl:attribute name="tipo">
						<xsl:value-of select="'COPIA_SIMPLES'" />
					</xsl:attribute>
					<xsl:attribute name="descricao">
						<xsl:value-of select="'Pedido de Cópia Simples'" />
					</xsl:attribute>
					<xsl:value-of select="string(boolean(TPN_PEDIDO/TPN_REQUER/CB_REQUER_34 = $true))"/>
				</xsl:element>	
				
				<xsl:element name="info">
					<xsl:attribute name="tipo">
						<xsl:value-of select="'COPIA_MIDIA'" />
					</xsl:attribute>
					<xsl:attribute name="descricao">
						<xsl:value-of select="'Pedido de Cópia em Mídia'" />
					</xsl:attribute>
					<xsl:value-of select="string(boolean(TPN_PEDIDO/TPN_REQUER/CB_REQUER_35 = $true))"/>
				</xsl:element>

				<xsl:element name="info">
					<xsl:attribute name="tipo">
						<xsl:value-of select="'DOCUMENTO_1'" />
					</xsl:attribute>
					<xsl:attribute name="descricao">
						<xsl:value-of select="'Documento solicitado 1'" />
					</xsl:attribute>
					<xsl:attribute name="aux1">
						<xsl:value-of select="TPN_PEDIDO/TPN_REQUER/ED_REQUER_DOC_1_AUX_1"/>
					</xsl:attribute>
					<xsl:attribute name="aux2">
						<xsl:value-of select="TPN_PEDIDO/TPN_REQUER/ED_REQUER_DOC_1_AUX_2"/>
					</xsl:attribute>
					<xsl:value-of select="TPN_PEDIDO/TPN_REQUER/ED_REQUER_DOC_1"/>
				</xsl:element>
				
				<xsl:element name="info">
					<xsl:attribute name="tipo">
						<xsl:value-of select="'DOCUMENTO_2'" />
					</xsl:attribute>
					<xsl:attribute name="descricao">
						<xsl:value-of select="'Documento solicitado 2'" />
					</xsl:attribute>
					<xsl:attribute name="aux1">
						<xsl:value-of select="TPN_PEDIDO/TPN_REQUER/ED_REQUER_DOC_2_AUX_1"/>
					</xsl:attribute>
					<xsl:attribute name="aux2">
						<xsl:value-of select="TPN_PEDIDO/TPN_REQUER/ED_REQUER_DOC_2_AUX_2"/>
					</xsl:attribute>
					<xsl:value-of select="TPN_PEDIDO/TPN_REQUER/ED_REQUER_DOC_2"/>
				</xsl:element>
				
				<xsl:element name="info">
					<xsl:attribute name="tipo">
						<xsl:value-of select="'DOCUMENTO_3'" />
					</xsl:attribute>
					<xsl:attribute name="descricao">
						<xsl:value-of select="'Documento solicitado 3'" />
					</xsl:attribute>
					<xsl:attribute name="aux1">
						<xsl:value-of select="TPN_PEDIDO/TPN_REQUER/ED_REQUER_DOC_3_AUX_1"/>
					</xsl:attribute>
					<xsl:attribute name="aux2">
						<xsl:value-of select="TPN_PEDIDO/TPN_REQUER/ED_REQUER_DOC_3_AUX_2"/>
					</xsl:attribute>
					<xsl:value-of select="TPN_PEDIDO/TPN_REQUER/ED_REQUER_DOC_3"/>
				</xsl:element>
				
				<xsl:element name="info">
					<xsl:attribute name="tipo">
						<xsl:value-of select="'DOCUMENTO_4'" />
					</xsl:attribute>
					<xsl:attribute name="descricao">
						<xsl:value-of select="'Documento solicitado 4'" />
					</xsl:attribute>
					<xsl:attribute name="aux1">
						<xsl:value-of select="TPN_PEDIDO/TPN_REQUER/ED_REQUER_DOC_4_AUX_1"/>
					</xsl:attribute>
					<xsl:attribute name="aux2">
						<xsl:value-of select="TPN_PEDIDO/TPN_REQUER/ED_REQUER_DOC_4_AUX_2"/>
					</xsl:attribute>
					<xsl:value-of select="TPN_PEDIDO/TPN_REQUER/ED_REQUER_DOC_4"/>
				</xsl:element>
