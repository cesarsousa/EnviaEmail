...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	<xsl:output method="xml" version="1.0" encoding="UTF-8" indent="yes" doctype-system="brf111-request-v2.6.dtd"/>
	...
	<xsl:template match="PG_PEDIDO">
		...
		<xsl:element name="info-processo">
			...
			<xsl:element name="info-peticao">			
				...
				<info tipo="NUMERO_ACESSO" descricao="Número da Autorização de Acesso"><xsl:value-of select="TPN_PEDIDO/TPN_REQUER/ED_REQUER_NUM_ORIGEM"/></info>
				<info tipo="ORIGEM_ACESSO" descricao="Origem do material genético e do conhecimento tradicional associado"><xsl:value-of select="TPN_PEDIDO/TPN_REQUER/MEM_REQUER_ORIGEM_ACESSO"/></info>
