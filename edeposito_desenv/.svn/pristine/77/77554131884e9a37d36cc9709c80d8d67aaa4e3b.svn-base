...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	<xsl:output method="xml" version="1.0" encoding="UTF-8" indent="yes" doctype-system="brf104-request-v2.6.dtd"/>
	...
	<xsl:template match="PG_PEDIDO">
		...
		<xsl:element name="info-processo">
			...
			<xsl:element name="info-peticao">
				...
				<info tipo="TIPOREQUER_1" descricao="Transferência de Titular"><xsl:value-of select="string(boolean(TPN_PEDIDO/TPN_REQUER/RB_REQUER_1 = $true))"/></info>
				<info tipo="TIPOREQUER_2" descricao="Alteração de Nome"><xsl:value-of select="string(boolean(TPN_PEDIDO/TPN_REQUER/RB_REQUER_2 = $true))"/></info>
				<info tipo="TIPOREQUER_3" descricao="Alteração de Sede"><xsl:value-of select="string(boolean(TPN_PEDIDO/TPN_REQUER/RB_REQUER_3 = $true))"/></info>
				<info tipo="REQUER_1" descricao="Documento de Alteração de Nome ou de Sede"><xsl:value-of select="string(boolean(TPN_PEDIDO/TPN_REQUER/CB_REQUER_1 = $true))"/></info>
				<info tipo="REQUER_2" descricao="Carta Patente / Certificado de Adição."><xsl:value-of select="string(boolean(TPN_PEDIDO/TPN_REQUER/CB_REQUER_2 = $true))"/></info>
				<info tipo="REQUER_3" descricao="Procuração"><xsl:value-of select="string(boolean(TPN_PEDIDO/TPN_REQUER/CB_REQUER_13 = $true))"/></info>
				<info tipo="REQUER_4" descricao="Documento de Cessão e/ou Transferência"><xsl:value-of select="string(boolean(TPN_PEDIDO/TPN_REQUER/CB_REQUER_3 = $true))"/></info>
				<info tipo="REQUER_OUTROS_5" descricao="Outros documentos"><xsl:value-of select="string(boolean(TPN_PEDIDO/TPN_REQUER/CB_REQUER_OUTROS = $true))"/></info>
	...
	<xsl:template match="PG_NOME">
		<xsl:element name="participantes">
			...
			<xsl:apply-templates select="CLCN_NOME/CLCN_CEDENTE" />			
		</xsl:element>
	</xsl:template>
	...
	<!-- Cedentes -->
	<xsl:template match="CLCN_CEDENTE">
		<xsl:element name="cedentes">
			<xsl:apply-templates select="CLCN_ITEM_CEDENTE_PJ"/>
			<xsl:apply-templates select="CLCN_ITEM_CEDENTE_PF"/>
		</xsl:element>
	</xsl:template>
	
	<xsl:template match="CLCN_ITEM_CEDENTE_PJ">
		<xsl:element name="cedente">
			...
			<xsl:call-template name="montar-livro-enderecos">
				<xsl:with-param name="tipo" select="$pessoa-juridica" />
				<xsl:with-param name="nome" select="PNL_CEDENTE_PJ_NOME/ED_CEDENTE_PJ_EMPRESA" />
				<xsl:with-param name="cpf-cnpj" select="PNL_CEDENTE_PJ_NOME/ED_CEDENTE_PJ_CNPJ" />
				<xsl:with-param name="logradouro" select="PNL_CEDENTE_PJ_ENDERECO/ED_CEDENTE_PJ_ENDERECO" />
				<xsl:with-param name="cidade" select="PNL_CEDENTE_PJ_ENDERECO/ED_CEDENTE_PJ_CIDADE" />
				<xsl:with-param name="estado" select="PNL_CEDENTE_PJ_ENDERECO/CCBB_CEDENTE_PJ_ESTADO" />
				<xsl:with-param name="estado-extenso">
					<xsl:choose>
						<xsl:when test="normalize-space(PNL_CEDENTE_PJ_ENDERECO/CCBB_CEDENTE_PJ_ESTADO/@content) != $vazio">
							<xsl:value-of select="PNL_CEDENTE_PJ_ENDERECO/CCBB_CEDENTE_PJ_ESTADO/@content" />
						</xsl:when>
						<xsl:otherwise><xsl:value-of select="PNL_CEDENTE_PJ_ENDERECO/ED_CEDENTE_PJ_ESTADO" /></xsl:otherwise>
					</xsl:choose>
				</xsl:with-param>
				<xsl:with-param name="codigo-postal" select="PNL_CEDENTE_PJ_ENDERECO/ED_CEDENTE_PJ_CEP" />
				<xsl:with-param name="pais" select="PNL_CEDENTE_PJ_ENDERECO/CCBB_CEDENTE_PJ_PAIS" />
				<xsl:with-param name="pais-extenso" select="PNL_CEDENTE_PJ_ENDERECO/CCBB_CEDENTE_PJ_PAIS/@content" />
				<xsl:with-param name="telefone" select="PNL_CEDENTE_PJ_CONTATO/ED_CEDENTE_PJ_FONE" />
				<xsl:with-param name="fax" select="PNL_CEDENTE_PJ_CONTATO/ED_CEDENTE_PJ_FAX" />
				<xsl:with-param name="email" select="PNL_CEDENTE_PJ_CONTATO/ED_CEDENTE_PJ_EMAIL" />
			</xsl:call-template>
		</xsl:element>
	</xsl:template>

	<xsl:template match="CLCN_ITEM_CEDENTE_PF">
		<xsl:element name="cedente">
			...
			<xsl:call-template name="montar-livro-enderecos">
				<xsl:with-param name="tipo" select="$pessoa-fisica" />
				<xsl:with-param name="qualificacao" select="PNL_CEDENTE_PF_NOME/ED_CEDENTE_PF_TITULO" />
				<xsl:with-param name="nome" select="PNL_CEDENTE_PF_NOME/ED_CEDENTE_PF_NOME" />
				<xsl:with-param name="sobrenome" select="PNL_CEDENTE_PF_NOME/ED_CEDENTE_PF_SOBRENOME" />
				<xsl:with-param name="cpf-cnpj" select="PNL_CEDENTE_PF_NOME/ED_CEDENTE_PF_CPF" />
				<xsl:with-param name="logradouro" select="PNL_CEDENTE_PF_ENDERECO/ED_CEDENTE_PF_ENDERECO" />
				<xsl:with-param name="cidade" select="PNL_CEDENTE_PF_ENDERECO/ED_CEDENTE_PF_CIDADE" />
				<xsl:with-param name="estado" select="PNL_CEDENTE_PF_ENDERECO/CCBB_CEDENTE_PF_ESTADO" />
				<xsl:with-param name="estado-extenso">
					<xsl:choose>
						<xsl:when test="normalize-space(PNL_CEDENTE_PF_ENDERECO/CCBB_CEDENTE_PF_ESTADO/@content) != $vazio">
							<xsl:value-of select="PNL_CEDENTE_PF_ENDERECO/CCBB_CEDENTE_PF_ESTADO/@content" />
						</xsl:when>
						<xsl:otherwise><xsl:value-of select="PNL_CEDENTE_PF_ENDERECO/ED_CEDENTE_PF_ESTADO" /></xsl:otherwise>
					</xsl:choose>
				</xsl:with-param>
				<xsl:with-param name="codigo-postal" select="PNL_CEDENTE_PF_ENDERECO/ED_CEDENTE_PF_CEP" />
				<xsl:with-param name="pais" select="PNL_CEDENTE_PF_ENDERECO/CCBB_CEDENTE_PF_PAIS" />
				<xsl:with-param name="pais-extenso" select="PNL_CEDENTE_PF_ENDERECO/CCBB_CEDENTE_PF_PAIS/@content" />
				<xsl:with-param name="telefone" select="PNL_CEDENTE_PF_CONTATO/ED_CEDENTE_PF_FONE" />
				<xsl:with-param name="fax" select="PNL_CEDENTE_PF_CONTATO/ED_CEDENTE_PF_FAX" />
				<xsl:with-param name="email" select="PNL_CEDENTE_PF_CONTATO/ED_CEDENTE_PF_EMAIL" />
			</xsl:call-template>
		</xsl:element>
	</xsl:template>	
