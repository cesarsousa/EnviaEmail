...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	...
	<xsl:template match="info-processo">
		<xsl:element name="TPN_PEDIDO">
			...
			<xsl:element name="TPN_REQUER">
				...
				<xsl:element name="MEM_REQUER_PRAZO">
					<xsl:value-of select="info-peticao/info[@tipo='DEVOLUCAO_REQUER']"/>					
				</xsl:element>
				<xsl:element name="MEM_REQUER_JUSTIFICATIVA">
					<xsl:value-of select="info-peticao/info[@tipo='DEVOLUCAO_JUSTIFICATIVA']"/>					
				</xsl:element>
				<xsl:element name="ED_NUM_PUB_RPI">
					<xsl:value-of select="info-peticao/info[@tipo='DEVOLUCAO_RPI']"/>					
				</xsl:element>
				<xsl:element name="CB_COMPROVANTE_JUSTIFICATIVA">
					<xsl:value-of select="string(boolean(info-peticao/info[@tipo='DEVOLUCAO_COMPROVANTE'] = $true))"/>					
				</xsl:element>				
	...
	<!-- Criar colecoes de GRU isentas de pagamento de taxa de servico -->
