...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	...
	<xsl:template match="info-processo">
		<xsl:element name="TPN_PEDIDO">
			...
			<xsl:element name="TPN_REQUER">			
				...
				<xsl:element name="CB_REQUER_4">
					<xsl:value-of select="string(boolean(info-peticao/info[@tipo='REQUER_4'] = $true))"/>					
				</xsl:element>
				<xsl:element name="CB_REQUER_5">
					<xsl:value-of select="string(boolean(info-peticao/info[@tipo='REQUER_5'] = $true))"/>					
				</xsl:element>
				<xsl:element name="CB_REQUER_6">
					<xsl:value-of select="string(boolean(info-peticao/info[@tipo='REQUER_6'] = $true))"/>					
				</xsl:element>
				<xsl:element name="CB_REQUER_7">
					<xsl:value-of select="string(boolean(info-peticao/info[@tipo='REQUER_7'] = $true))"/>
				</xsl:element>
				<xsl:element name="CB_REQUER_8">
					<xsl:value-of select="string(boolean(info-peticao/info[@tipo='REQUER_8'] = $true))"/>
				</xsl:element>
				<xsl:element name="CB_REQUER_9">
					<xsl:value-of select="string(boolean(info-peticao/info[@tipo='REQUER_9'] = $true))"/>					
				</xsl:element>
				<xsl:element name="CB_REQUER_10">
					<xsl:value-of select="string(boolean(info-peticao/info[@tipo='REQUER_10'] = $true))"/>					
				</xsl:element>
				<xsl:element name="CB_REQUER_11">
					<xsl:value-of select="string(boolean(info-peticao/info[@tipo='REQUER_11'] = $true))"/>					
				</xsl:element>
				<xsl:element name="CB_REQUER_12">
					<xsl:value-of select="string(boolean(info-peticao/info[@tipo='REQUER_12'] = $true))"/>					
				</xsl:element>
				<xsl:element name="CB_REQUER_13">
					<xsl:value-of select="string(boolean(info-peticao/info[@tipo='REQUER_13'] = $true))"/>					
				</xsl:element>
				<xsl:element name="CB_REQUER_14">
					<xsl:value-of select="string(boolean(info-peticao/info[@tipo='REQUER_14'] = $true))"/>					
				</xsl:element>
				<xsl:element name="CB_REQUER_15">
					<xsl:value-of select="string(boolean(info-peticao/info[@tipo='REQUER_15'] = $true))"/>					
				</xsl:element>
				<xsl:element name="CB_REQUER_16">
					<xsl:value-of select="string(boolean(info-peticao/info[@tipo='REQUER_16'] = $true))"/>					
				</xsl:element>
				<xsl:element name="CB_REQUER_17">
					<xsl:value-of select="string(boolean(info-peticao/info[@tipo='REQUER_17'] = $true))"/>
				</xsl:element>
				<xsl:element name="CB_REQUER_18">
					<xsl:value-of select="string(boolean(info-peticao/info[@tipo='REQUER_18'] = $true))"/>
				</xsl:element>
				<xsl:element name="CB_REQUER_19">
					<xsl:value-of select="string(boolean(info-peticao/info[@tipo='REQUER_19'] = $true))"/>					
				</xsl:element>
				<xsl:element name="CB_REQUER_20">
					<xsl:value-of select="string(boolean(info-peticao/info[@tipo='REQUER_20'] = $true))"/>					
				</xsl:element>
				<xsl:element name="CB_REQUER_21">
					<xsl:value-of select="string(boolean(info-peticao/info[@tipo='REQUER_21'] = $true))"/>					
				</xsl:element>
				<xsl:element name="CB_REQUER_22">
					<xsl:value-of select="string(boolean(info-peticao/info[@tipo='REQUER_22'] = $true))"/>					
				</xsl:element>
				<xsl:element name="CB_REQUER_23">
					<xsl:value-of select="string(boolean(info-peticao/info[@tipo='REQUER_23'] = $true))"/>					
				</xsl:element>
				<xsl:element name="CB_REQUER_24">
					<xsl:value-of select="string(boolean(info-peticao/info[@tipo='REQUER_24'] = $true))"/>					
				</xsl:element>
				<xsl:element name="CB_REQUER_25">
					<xsl:value-of select="string(boolean(info-peticao/info[@tipo='REQUER_25'] = $true))"/>					
				</xsl:element>
				<xsl:element name="CB_REQUER_26">
					<xsl:value-of select="string(boolean(info-peticao/info[@tipo='REQUER_26'] = $true))"/>					
				</xsl:element>
				<xsl:element name="CB_REQUER_27">
					<xsl:value-of select="string(boolean(info-peticao/info[@tipo='REQUER_27'] = $true))"/>
				</xsl:element>
				<xsl:element name="CB_REQUER_28">
					<xsl:value-of select="string(boolean(info-peticao/info[@tipo='REQUER_28'] = $true))"/>
				</xsl:element>
				<xsl:element name="CB_REQUER_29">
					<xsl:value-of select="string(boolean(info-peticao/info[@tipo='REQUER_29'] = $true))"/>					
				</xsl:element>
				<xsl:element name="CB_REQUER_30">
					<xsl:value-of select="string(boolean(info-peticao/info[@tipo='REQUER_30'] = $true))"/>					
				</xsl:element>
				<xsl:element name="CB_REQUER_OUTROS">
					<xsl:value-of select="string(boolean(info-peticao/info[@tipo='REQUER_OUTROS_31'] = $true))"/>					
				</xsl:element>
	...
	<xsl:template match="documentos">
		<xsl:element name="PC_DOCUMENTO">
			...
			<xsl:element name="TS_SERVICOS_ISENTOS">
				<xsl:element name="CLCN_GRU">
					<xsl:element name="CLCN_GRU_ISENTA">						
						<xsl:for-each select="//GRUs/gru[@isenta = $true]">
							<xsl:call-template name="crias-grus-isentas"/>
						</xsl:for-each>						
					</xsl:element>
				</xsl:element>
			</xsl:element>		
	...
	<xsl:template name="crias-grus-isentas">		
			<xsl:element name="CLCN_ITEM_GRU_ISENTA">
				<xsl:element name="CCBB_GRU_ISENTA_COD_SERVICO">
					<xsl:value-of select="@servico"/>
				</xsl:element>
				<xsl:element name="ED_GRU_ISENTA_NUM_GRU">
					<xsl:value-of select="@numero"/>
				</xsl:element>				
				<xsl:element name="ED_GRU_ISENTA_NUM_RPI">
					<xsl:value-of select="@rpi"/>
				</xsl:element>
				<xsl:element name="ED_GRU_ISENTA_NOME_DEP">
					<xsl:choose>
