...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	<xsl:output method="xml" version="1.0" encoding="UTF-8" indent="yes" doctype-system="brf112-request-v2.6.dtd"/>
	...
	<xsl:template match="PG_PEDIDO">
		...
		<xsl:element name="info-processo">
			...
			<xsl:element name="info-peticao">			
				...
				<info tipo="DECLARACAO_NEGATIVA" descricao="Declaração na forma do § 2º do Artigo 3º da Resolução INPI Nº 69/2013"><xsl:value-of select="string(boolean(TPN_PEDIDO/TPN_DECLARACAO/CB_DECLARACAO_NEGATIVA = $true))"/></info>
