	...
	<xsl:template match="info-processo">
		<xsl:element name="TPN_PEDIDO">
			...
			<xsl:element name="TPN_REQUER">			
				<xsl:element name="RB_REQUER_MOTIVO_IDADE">
					<xsl:value-of select="string(boolean(info-peticao/info[@tipo='MOTIVO_IDADE'] = $true))"/>					
				</xsl:element>
				<xsl:element name="RB_REQUER_MOTIVO_TERCEIROS">
					<xsl:value-of select="string(boolean(info-peticao/info[@tipo='MOTIVO_TERCEIROS'] = $true))"/>					
				</xsl:element>
				<xsl:element name="RB_REQUER_MOTIVO_FOMENTO">
					<xsl:value-of select="string(boolean(info-peticao/info[@tipo='MOTIVO_FOMENTO'] = $true))"/>					
				</xsl:element>
				<xsl:element name="RB_REQUER_MOTIVO_ACUSADO">
					<xsl:value-of select="string(boolean(info-peticao/info[@tipo='MOTIVO_ACUSADO'] = $true))"/>					
				</xsl:element>
				<xsl:element name="RB_REQUER_MOTIVO_SAUDE">
					<xsl:value-of select="string(boolean(info-peticao/info[@tipo='MOTIVO_SAUDE'] = $true))"/>					
				</xsl:element>
				
				<xsl:element name="CB_REQUER_13">
					<xsl:value-of select="string(boolean(info-peticao/info[@tipo='REQUER_13'] = $true))"/>					
				</xsl:element>
				<xsl:element name="CB_REQUER_36">
					<xsl:value-of select="string(boolean(info-peticao/info[@tipo='REQUER_36'] = $true))"/>
				</xsl:element>
				<xsl:element name="CB_REQUER_37">
					<xsl:value-of select="string(boolean(info-peticao/info[@tipo='REQUER_37'] = $true))"/>
				</xsl:element>
				<xsl:element name="CB_REQUER_38">
					<xsl:value-of select="string(boolean(info-peticao/info[@tipo='REQUER_38'] = $true))"/>					
				</xsl:element>
				<xsl:element name="CB_REQUER_39">
					<xsl:value-of select="string(boolean(info-peticao/info[@tipo='REQUER_39'] = $true))"/>					
				</xsl:element>
				<xsl:element name="CB_REQUER_40">
					<xsl:value-of select="string(boolean(info-peticao/info[@tipo='REQUER_40'] = $true))"/>					
				</xsl:element>
				<xsl:element name="CB_REQUER_41">
					<xsl:value-of select="string(boolean(info-peticao/info[@tipo='REQUER_41'] = $true))"/>					
				</xsl:element>				
