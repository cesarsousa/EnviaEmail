	...
	<xsl:template match="info-processo">
		<xsl:element name="TPN_PEDIDO">
			...
			<xsl:element name="TPN_REQUER">				
				...
				<xsl:element name="ED_REQUER_NUM_ORIGEM">
					<xsl:value-of select="info-peticao/info[@tipo='NUMERO_ACESSO']"/>					
				</xsl:element>

				<xsl:element name="MEM_REQUER_ORIGEM_ACESSO">
					<xsl:value-of select="info-peticao/info[@tipo='ORIGEM_ACESSO']"/>					
				</xsl:element>
