...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	...
	<xsl:template match="info-processo">
		<xsl:element name="TPN_PEDIDO">
			...
			<xsl:element name="TPN_DECLARACAO">			
				<xsl:element name="CB_DECLARACAO_NEGATIVA">
					<xsl:value-of select="string(boolean(info-peticao/info[@tipo='DECLARACAO_NEGATIVA'] = $true))"/>					
				</xsl:element>
			</xsl:element>
