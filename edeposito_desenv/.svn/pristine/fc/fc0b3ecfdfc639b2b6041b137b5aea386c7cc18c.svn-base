...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	...
	<xsl:template match="BRF101">
		<application-body>
			...
			<description>
				<xsl:choose>
					<xsl:when test="./PAGINAS/PG_DOCUMENTO/PC_DOCUMENTO/TS_ESPECIFICACAO/CLCN_ESPECIFICACAO/PNL_ESPECIFICACAO_entity/document/@documentcode='RELATDESC'">
						<xsl:apply-templates select="./PAGINAS/PG_DOCUMENTO/PC_DOCUMENTO/TS_ESPECIFICACAO/CLCN_ESPECIFICACAO/PNL_ESPECIFICACAO_entity/document[@documentcode='RELATDESC']"/>
					</xsl:when>
					<xsl:otherwise>
			...
			<claims>
				<xsl:choose>
					<xsl:when test="./PAGINAS/PG_DOCUMENTO/PC_DOCUMENTO/TS_ESPECIFICACAO/CLCN_ESPECIFICACAO/PNL_ESPECIFICACAO_entity/document/@documentcode='REIVIND'">
						<xsl:apply-templates select="./PAGINAS/PG_DOCUMENTO/PC_DOCUMENTO/TS_ESPECIFICACAO/CLCN_ESPECIFICACAO/PNL_ESPECIFICACAO_entity/document[@documentcode='REIVIND']"/>
					</xsl:when>
					<xsl:otherwise>
						<doc-page he="1" wi="1" type="pdf" file="">
						</doc-page>
			...
			<xsl:apply-templates select="./PAGINAS/PG_DOCUMENTO/PC_DOCUMENTO/TS_ESPECIFICACAO/CLCN_ESPECIFICACAO/PNL_ESPECIFICACAO_entity/document[@documentcode='RESUMO']"/>
			<xsl:apply-templates select="./PAGINAS/PG_DOCUMENTO/PC_DOCUMENTO/TS_ESPECIFICACAO/CLCN_ESPECIFICACAO/PNL_ESPECIFICACAO_entity/document[@documentcode='DESENHOS']"/>
			<!--</xsl:when>-->
			<!--</xsl:choose>-->
		</application-body>
	</xsl:template>
	...
	<xsl:template match="document">
		<xsl:choose>
			<xsl:when test="./@documentcode ='RELATDESC'">
				<doc-page>
			...
			<xsl:when test="./@documentcode ='REIVIND'">
				<doc-page>
					<xsl:attribute name="id">
						<xsl:value-of select="@documentcode"/>
					</xsl:attribute>
			...
			<xsl:when test="./@documentcode ='RESUMO'">
				<abstract>
					<doc-page>
						<xsl:attribute name="id">
							<xsl:value-of select="@documentcode"/>
			...
			<xsl:when test="./@documentcode ='DESENHOS'">
				<drawings>
					<doc-page>
						<xsl:attribute name="id">
							<xsl:value-of select="@documentcode"/>
