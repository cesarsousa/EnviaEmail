...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	...
	<xsl:variable name="language" select="/BRF105/@language_of_proceedings"/>
	<xsl:template match="BRF105">
		<internal>
			<xml-documents>
				<doc infile="data.xml" xslfile="brf105-request.xslt" outfile="brf105-request.xml" signatory="false"/>
			...
			<pdf-documents>
				<doc infile="brf105-request.xml" outfile="brf105-request.pdf" signatory="true" id="0">
					<xsl:variable name="switch_lang_request_xfo">
						<xsl:call-template name="SwitchXFOfileName">
							<xsl:with-param name="FileName" select="'brf105-request.xfo'"/>
						</xsl:call-template>
					</xsl:variable>
