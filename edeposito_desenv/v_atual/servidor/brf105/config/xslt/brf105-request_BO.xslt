	...
	<xsl:template match="info-processo">
		<xsl:element name="TPN_PEDIDO">
			...
			<xsl:element name="TPN_REQUER">			
				<xsl:element name="CB_REQUER_34">
					<xsl:value-of select="string(boolean(info-peticao/info[@tipo='COPIA_SIMPLES'] = $true))"/>					
				</xsl:element>
				<xsl:element name="CB_REQUER_35">
					<xsl:value-of select="string(boolean(info-peticao/info[@tipo='COPIA_MIDIA'] = $true))"/>					
				</xsl:element>
				
				<xsl:element name="ED_REQUER_DOC_1">
					<xsl:value-of select="info-peticao/info[@tipo='DOCUMENTO_1']"/>					
				</xsl:element>
				<xsl:element name="ED_REQUER_DOC_1_AUX_1">
					<xsl:value-of select="info-peticao/info[@tipo='DOCUMENTO_1']/@aux1"/>					
				</xsl:element>
				<xsl:element name="ED_REQUER_DOC_1_AUX_2">
					<xsl:value-of select="info-peticao/info[@tipo='DOCUMENTO_1']/@aux2"/>					
				</xsl:element>
				
				<xsl:element name="ED_REQUER_DOC_2">
					<xsl:value-of select="info-peticao/info[@tipo='DOCUMENTO_2']"/>					
				</xsl:element>
				<xsl:element name="ED_REQUER_DOC_2_AUX_1">
					<xsl:value-of select="info-peticao/info[@tipo='DOCUMENTO_2']/@aux1"/>					
				</xsl:element>
				<xsl:element name="ED_REQUER_DOC_2_AUX_2">
					<xsl:value-of select="info-peticao/info[@tipo='DOCUMENTO_2']/@aux2"/>					
				</xsl:element>
				
				<xsl:element name="ED_REQUER_DOC_3">
					<xsl:value-of select="info-peticao/info[@tipo='DOCUMENTO_3']"/>					
				</xsl:element>
				<xsl:element name="ED_REQUER_DOC_3_AUX_1">
					<xsl:value-of select="info-peticao/info[@tipo='DOCUMENTO_3']/@aux1"/>					
				</xsl:element>
				<xsl:element name="ED_REQUER_DOC_3_AUX_2">
					<xsl:value-of select="info-peticao/info[@tipo='DOCUMENTO_3']/@aux2"/>					
				</xsl:element>
				
				<xsl:element name="ED_REQUER_DOC_4">
					<xsl:value-of select="info-peticao/info[@tipo='DOCUMENTO_4']"/>					
				</xsl:element>
				<xsl:element name="ED_REQUER_DOC_4_AUX_1">
					<xsl:value-of select="info-peticao/info[@tipo='DOCUMENTO_4']/@aux1"/>					
				</xsl:element>
				<xsl:element name="ED_REQUER_DOC_4_AUX_2">
					<xsl:value-of select="info-peticao/info[@tipo='DOCUMENTO_4']/@aux2"/>					
				</xsl:element>
