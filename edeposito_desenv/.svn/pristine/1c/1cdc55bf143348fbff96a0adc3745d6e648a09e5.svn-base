...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	<xsl:output method="xml" version="1.0" encoding="UTF-8" indent="yes" doctype-system="brf108-request-v2.6.dtd"/>
	...
	<xsl:template match="PG_PEDIDO">
		...
		<xsl:element name="info-processo">
			...
			<xsl:element name="info-peticao">
				<info tipo="DEVOLUCAO_REQUER" descricao="Definição"><xsl:value-of select="TPN_PEDIDO/TPN_REQUER/MEM_REQUER_PRAZO"/></info>
				<info tipo="DEVOLUCAO_RPI" descricao="Revista"><xsl:value-of select="TPN_PEDIDO/TPN_REQUER/ED_NUM_PUB_RPI"/></info>
				<info tipo="DEVOLUCAO_JUSTIFICATIVA" descricao="Justificativa"><xsl:value-of select="TPN_PEDIDO/TPN_REQUER/MEM_REQUER_JUSTIFICATIVA"/></info>
				<info tipo="DEVOLUCAO_COMPROVANTE" descricao="Comprovante"><xsl:value-of select="string(boolean(TPN_PEDIDO/TPN_REQUER/CB_COMPROVANTE_JUSTIFICATIVA = $true))"/></info>
			</xsl:element>			
